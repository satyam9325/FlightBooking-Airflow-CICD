...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-dev")
    bq_project = Variable.get("bq_project", default_var="cohesive-link-441704-s4")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "433337872479-compute@developer.gserviceaccount.com",
                "network_uri": "projects/cohesive-link-441704-s4/global/networks/default",
                "subnetwork_uri": "projects/cohesive-link-441704-s4/regions/us-east4/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="cohesive-link-441704-s4",
        region="us-east4",
